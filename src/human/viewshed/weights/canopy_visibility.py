...
def compose_dual_surface_artifacts(
    *,
    ...
    validate_final_artifact(paths.dual_surface_factors, FINAL_SCHEMAS["dual_surface_factors"])
    ...
    for artifact_name, artifact_path in (
        ...
        validate_final_artifact(artifact_path, FINAL_SCHEMAS[artifact_name])
