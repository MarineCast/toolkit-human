"""
Prepare regional USGS 3DEP elevation rasters for OrcaCast viewshed modeling.
...
Typical usage
-------------
    python -m <package>.prepare.elevation.acquire --config config/modeling/effort/viewshed.yaml --verbose
    python -m <package>.prepare.elevation.acquire --config config/modeling/effort/viewshed.yaml --resolutions 10 30
    python -m <package>.prepare.elevation.acquire --config config/modeling/effort/viewshed.yaml --chunk-grid 4x3
"""
