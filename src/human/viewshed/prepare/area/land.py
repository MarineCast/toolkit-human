...
def build_land_cells_for_config(
    ...
    *,
    ...
    ne_path = (
        resolve_existing_or_relative(configured_land_path, config_dir)
    ...
    if land_union is None:
        ...
        water_path = (
            resolve_existing_or_relative(water_path_value, config_dir)
            if water_path_value
