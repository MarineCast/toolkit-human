...
from human.viewshed.prepare.area import raster_stack
from human.viewshed.prepare.elevation import terrain
...
def test_canonical_water_contract_uses_configured_land_source() -> None:
